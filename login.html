...
<html lang="fr">
<head>
<title>Haïtianité | Se connecter</title>
<meta charset="utf-8">
			...
			<div class="row login_row">
				<div class="col-lg-8">
					...
					<div class="login">
						...
						<div class="reply_title">Se connecter</div>
						<div class="reply_form_container">
							...
							<form id="login_form" action="post">
								<div>
									...
									<input id="login_form_subject" class="input_field login_form_name" type="text" placeholder="Mot de passe" required="required" data-error="Subject is required.">									
								</div>
								<div>
							...
							<label>Je suis nouveau</label>
							<button id="login_form_submit" class="login_submit_btn trans_300" onclick="location.href='signup.php'">
										Creer un compte
									</button>
