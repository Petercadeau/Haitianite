...
<html lang="fr">
<head>
<title>Haïtianité- Contact</title>
<meta charset="utf-8">
	...
	<header class="header d-flex flex-row justify-content-end align-items-center trans_200">
		...
		<nav class="main_nav justify-self-end text-right">
			<ul>
				...
				<li class="active"><a href="login.html">Connecter</a></li>
			</ul>
			...
			<div class="row login_row">
				<div class="col-lg-8">
					...
					<div class="login">
						...
						<div class="reply_title">Creation d'un nouveau compte</div>
						<div class="reply_form_container">
							...
							<form id="login_form" action="post">
								<div>
									<input id="login_form_name" class="input_field login_form_name" type="text" placeholder="Nom d'utilisateur" required="required" data-error="Name is required.">
									<input id="login_form_email" class="input_field login_form_email" type="email" placeholder="E-mail" required="required" data-error="Valid email is required.">
									<input id="login_form_subject" class="input_field login_form_subject" type="text" placeholder="Mot de passe" required="required" data-error="Subject is required.">
									<input id="login_form_message" class="input_field login_form_subject" name="message"  placeholder="Répéter le mot de passe" rows="4" required data-error="Please, write us a message."/>
									<input type="checkbox" name="termscondition" required=""><label>J'accepte les termes et les confitions</label>
								</div>
								<div>
									<button id="login_form_submit" type="submit" class="login_submit_btn trans_300" value="Submit">
										Creer le compte
									</button>
								</div>
